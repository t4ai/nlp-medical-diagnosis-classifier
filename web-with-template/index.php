...
<body>
					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        ...
					        <li><a class="menu" href="#about">self diagnosis</a></li>
	...
	<section class="about text-center" id="about">
		<div class="container">
			...
			<h1 style="margin-top: 4rem">Self-Service Patient Diagnosis Agent</h1>
			<div class="row">
				<div class="predection-container">
					<form id="form" class="form predectionForm" action="predection.php" method="post" onsubmit="return false;">
						<img src="logo-v2.PNG" style="max-width: 100%;margin-bottom: 1rem;">
						<div class="">
							<textarea name="data" id="data" cols="30" rows="10" placeholder="Enter Symptoms"></textarea>
						</div>
	...
	<div class="api-map" id="contact">
		<div class="">
			<div class="row m-0 p-0">
				<div class="col-md-12 map p-0 m-0" id="map">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d79456.08982052762!2d-0.23148499155881305!3d51.51316449999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4876052b13a40001%3A0x240f2b6538bdf77f!2s123V!5e0!3m2!1sen!2sus!4v1691918232443!5m2!1sen!2sus" style="width: 104%;
    height: 100%;
    margin-left: -3%;" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				...
				<div class="contact-caption clearfix">
					...
					<div class="col-md-5 contact-info text-left">
						...
						<div class="info-detail">
							...
							<ul><li><i class="fa fa-envelope"></i><span>Email:</span> info@t3-systems.com</li></ul>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 footer-para">
					<p>&copy;T3 systems All right reserved</p>
				</div>
